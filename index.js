...
console.log(`${getFilePath("saipan")}ssi/ah/`);
console.log(`${getFilePath("guam")}ssi/ah/`);

//write a file inside a folder
// let name = "test"
// fs.writeFile(`${getFilePath("rome")}${name}.txt`, 'This is my textingsssssssssssssssss', function (err) {
//   // if (err) throw err;               
//   // console.log(`${area_path[8]} Results Received`);
// }); 
